...
// Paths and files
window.SHAPES_PATH = window.SHAPES_PATH || './static/shapes';
// Path for images inside the diagram
window.GRAPH_IMAGE_PATH = window.GRAPH_IMAGE_PATH || './static/img';
...
window.TEMPLATE_PATH = window.TEMPLATE_PATH || './static/templates';
