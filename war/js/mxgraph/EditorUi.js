 ...
 * screen widths <= 640px.
 */
EditorUi.prototype.hsplitPosition = (screen.width <= 640) ? 118 : 147;
...
EditorUi.prototype.getCssClassForMarker = function(prefix, shape, marker, fill)
{
	...
	else
	{
		...
		{
			result = 'geSprite geSprite-' + prefix + 'lbog';
		}
		else if (marker == 'conflict')
		{
			result = 'geSprite geSprite-' + prefix + 'conflict';
		}
