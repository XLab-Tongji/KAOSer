...
var mxLog = {
    consoleName: "Console", TRACE: !1, DEBUG: !0, WARN: !0, buffer: "", init: function () {
        ...
        for (var a = "", b = 0; b < arguments.length; b++) a +=
            arguments[b], b < arguments.length - 1 && (a += " ");
        mxLog.write(a + "\n")
    }
}, mxObjectIdentity = {
...
var mxEffects = {
    ...
    mxUtils = {
        ...
        hasScrollbars: function (a) {
            ...
            return null != a && ("scroll" == a.overflow || "auto" ==
                a.overflow)
        },
        bind: function (a, b) {
            return function () {
        ...
        fit: function (a) {
            var b = parseInt(a.offsetLeft), c = parseInt(a.offsetWidth),
                d = mxUtils.getDocumentScrollOrigin(a.ownerDocument), e = d.x, d = d.y, f = document.body,
                g = document.documentElement, k = e + (f.clientWidth || g.clientWidth);
        ...
        arcToCurves: function (a, b, c, d, e, f, g, k, l) {
            ...
            for (var y = Math.cos(f), A = Math.sin(f), r = -m * (n * A + d * y), t = -m * (c * A - p * y), q = [], z = 0; z < g; ++z) {
                f += e;
                var y = Math.cos(f), A = Math.sin(f), u = n * y - d * A + k, x = c * y + p * A + l,
                    v = -m * (n * A + d * y), y = -m * (c * A - p * y), A = 6 * z;
                q[A] = Number(r + a);
                q[A + 1] = Number(t + b);
                q[A + 2] = Number(u - v + a);
                q[A + 3] = Number(x - y + b);
        ...
        getPortConstraints: function (a, b, c, d) {
            ...
            c = 0;
            1 == mxUtils.getValue(a.style, mxConstants.STYLE_PORT_CONSTRAINT_ROTATION, 0) && (c = mxUtils.getValue(a.style,
        ...
        getDocumentScrollOrigin: function (a) {
            ...
            return new mxPoint(null != a && void 0 !== window.pageXOffset ? window.pageXOffset : (document.documentElement || document.body.parentNode || document.body).scrollLeft, null != a && void 0 !== window.pageYOffset ? window.pageYOffset : (document.documentElement || document.body.parentNode ||
        ...
        popup: function (a, b) {
            if (b) {
                ...
                c.setClosable(!0);
                c.setVisible(!0)
            } else mxClient.IS_NS ? (c = window.open(), c.document.writeln("<pre>" + mxUtils.htmlEntities(a) +
...
var mxEvent = {
    ...
    removeGestureListeners: function (a, b, c, d) {
        ...
        null != c && mxEvent.removeListener(a,
            mxClient.IS_POINTER ? "pointermove" : "mousemove", c);
    ...
    addMouseWheelListener: function (a) {
        if (null != a) {
            var b = function (b) {
                ...
                var c;
                c = mxClient.IS_FF ? -b.detail / 2 : b.wheelDelta / 120;
                0 != c && a(b, 0 < c)
            };
    ...
    getMainEvent: function (a) {
        "touchstart" != a.type && "touchmove" != a.type || null == a.touches || null == a.touches[0] ?
            "touchend" == a.type && null != a.changedTouches && null != a.changedTouches[0] && (a = a.changedTouches[0]) : a = a.touches[0];
        return a
    },
...
mxWindow.prototype.show = function () {
    ...
    mxClient.IS_QUIRKS || "auto" != a.overflow && null == this.resize || (this.contentWrapper.style.height = this.div.offsetHeight - this.title.offsetHeight - this.contentHeightCorrection + "px");
...
mxSvgCanvas2D.prototype.addNode = function (a, b) {
    ...
    if (null != c) {
        ...
        !this.pointerEvents || "path" == c.nodeName && this.path[this.path.length - 1] != this.closeOp ? this.pointerEvents || null != this.originalRoot || c.setAttribute("pointer-events", "none") : c.setAttribute("pointer-events", this.pointerEventsValue);
...
mxSvgCanvas2D.prototype.updateFill = function () {
    ...
    if (null != a.fillColor) if (null != a.gradientColor) if (a = this.getSvgGradient(a.fillColor, a.gradientColor, a.gradientFillAlpha, a.gradientAlpha, a.gradientDirection), mxClient.IS_CHROME_APP || mxClient.IS_IE || mxClient.IS_IE11 || mxClient.IS_EDGE || this.root.ownerDocument != document) this.node.setAttribute("fill", "url(#" + a + ")"); else {
...
mxSvgCanvas2D.prototype.image = function (a, b, c, d, e, f, g, k) {
    ...
    this.root.appendChild(m);
    this.blockImagePointerEvents && (m.setAttribute("style", "pointer-events:none"), m = this.createElement("rect"),
...
mxSvgCanvas2D.prototype.createDiv = function (a, b, c, d, e) {
    c = this.state;
    d = "display:inline-block;font-size:" + c.fontSize + "px;font-family:" + c.fontFamily + ";color:" + c.fontColor + ";line-height:" + (mxConstants.ABSOLUTE_LINE_HEIGHT ? c.fontSize * mxConstants.LINE_HEIGHT + "px" : mxConstants.LINE_HEIGHT * this.lineHeightCorrection) + ";" + d;
    ...
    mxUtils.isNode(a) || (a = this.convertHtml(a), "fill" != e && "width" != e ? a = '<div xmlns="http://www.w3.org/1999/xhtml" style="display:inline-block;text-align:inherit;text-decoration:inherit;' +
        b + '">' + a + "</div>" : d += b);
...
mxSvgCanvas2D.prototype.updateText = function (a, b, c, d, e, f, g, k, l, m, n) {
    if (null != n && null != n.firstChild && null != n.firstChild.firstChild && null != n.firstChild.firstChild.firstChild) {
        ...
        t = (null != n.mxCachedOffsetWidth ? n.mxCachedOffsetWidth : u.offsetWidth) + 2;
        g && "fill" != k && (l && (t = Math.min(t, c)), q.style.width = t + "px");
        t = (null != n.mxCachedFinalOffsetWidth ? n.mxCachedFinalOffsetWidth : u.offsetWidth) + 2;
        g = (null != n.mxCachedFinalOffsetHeight ? n.mxCachedFinalOffsetHeight : u.offsetHeight) - 2;
        l && (g = Math.min(g, d), t = Math.min(t, c));
        "width" == k ? d = g : "fill" != k && (c = t, d = g);
        g = l = 0;
        e ==
        mxConstants.ALIGN_CENTER ? l -= c / 2 : e == mxConstants.ALIGN_RIGHT && (l -= c);
        a += l;
        f == mxConstants.ALIGN_MIDDLE ? g -= d / 2 : f == mxConstants.ALIGN_BOTTOM && (g -= d);
        "fill" != k && mxClient.IS_FF && mxClient.IS_WIN && (g -= 2);
        b += g;
        ...
        if (this.foEnabled && "html" == l) {
            ...
            if (null != t) {
                ...
                if (!mxClient.IS_IE || 9 != document.documentMode && mxClient.IS_SVG) {
                    ...
                    v = z.offsetWidth;
                    0 == v && t.parentNode == x && (t.style.visibility = "hidden", document.body.appendChild(t), v = z.offsetWidth);
                    this.cacheOffsetSize && (u.mxCachedOffsetWidth = v);
                    !n && k && 0 < c && this.root.ownerDocument != document && "fill" != m && "width" != m && (B = t.style.whiteSpace, t.style.whiteSpace = "nowrap", v <
                    z.offsetWidth && (t.style.whiteSpace = B));
                    y = v + y - 1;
                    k && "fill" != m && "width" != m && (n && (y = Math.min(y, c)), t.style.width = y + "px");
                    y = z.offsetWidth;
                    A = z.offsetHeight;
                    this.cacheOffsetSize && (u.mxCachedFinalOffsetWidth = y, u.mxCachedFinalOffsetHeight = A);
                    A -= q;
                    t.parentNode != x && (x.appendChild(t), t.style.visibility = "")
                } else {
                    ...
                    A.innerHTML = mxUtils.isNode(e) ? e.outerHTML : e;
                    z.appendChild(A);
                    document.body.appendChild(z);
                    8 != document.documentMode && 9 != document.documentMode && null != r.fontBorderColor && (y += 2, q += 2);
                    if (k && 0 < c) {
                        var v = A.offsetWidth;
                        if (!n && k && 0 < c && this.root.ownerDocument != document && "fill" != m) {
                            var B = z.style.whiteSpace;
                            A.style.whiteSpace = "nowrap";
                            v < A.offsetWidth && (z.style.whiteSpace = B)
                        }
                        n && (v = Math.min(v, c));
                        z.style.width = v + "px";
                        y = A.offsetWidth + y + 0;
                ...
                0 != r.rotation && this.rotateHtml ? (z += "rotate(" + r.rotation + "," + c / 2 + "," + d / 2 + ")", b = this.rotatePoint((a + c / 2) * r.scale, (b + d / 2) * r.scale, r.rotation, r.rotationCx, r.rotationCy), a = b.x - c * r.scale / 2, b = b.y - d * r.scale / 2) : (a *= r.scale, b *= r.scale);
                0 != p && (z += "rotate(" + p + "," + -t + "," + -q + ")");
                u.setAttribute("transform", "translate(" + (Math.round(a) + this.foOffset) + "," + (Math.round(b) + this.foOffset) + ")" + z);
                x.setAttribute("width",
                    Math.round(Math.max(1, c)));
                x.setAttribute("height", Math.round(Math.max(1, d)));
                this.root.ownerDocument != document && (a = this.createAlternateContent(x, a, b, c, d, e, f, g, k, l, m, n, p), null != a && (x.setAttribute("requiredFeatures", "http://www.w3.org/TR/SVG11/feature#Extensibility"), c = this.createElement("switch"), c.appendChild(x), c.appendChild(a), u.appendChild(c)))
            }
...
mxGuide.prototype.move = function (a, b, c) {
    if (null != this.states && (this.horizontal || this.vertical) && null != a && null != b) {
        var d = function (b) {
                b += this.graph.panDy;
                var c = !1;
                Math.abs(b - F) < y ? (l = b - a.getCenterY(), y = Math.abs(b - F), c = !0) : Math.abs(b - B) < y ? (l = b - a.y, y = Math.abs(b - B), c = !0) : Math.abs(b - C) < y && (l = b - a.y - a.height, y = Math.abs(b - C), c = !0);
                c && (r = D, t = Math.round(b - this.graph.panDy), null == this.guideY && (this.guideY = this.createGuideShape(!1), this.guideY.dialect = this.graph.dialect != mxConstants.DIALECT_SVG ? mxConstants.DIALECT_VML :
                    mxConstants.DIALECT_SVG, this.guideY.pointerEvents = !1, this.guideY.init(this.graph.getView().getOverlayPane())));
                q = q || c
            }, e = function (b, c) {
                b += this.graph.panDx;
                var d = !1;
                Math.abs(b - v) < x ? (k = b - a.getCenterX(), x = Math.abs(b - v), d = !0) : Math.abs(b - A) < x ? (k = b - a.x, x = Math.abs(b - A), d = !0) : Math.abs(b - z) < x && (k = b - a.x - a.width, x = Math.abs(b - z), d = !0);
                d && (n = c, p = Math.round(b - this.graph.panDx), null == this.guideX && (this.guideX = this.createGuideShape(!0), this.guideX.dialect = this.graph.dialect != mxConstants.DIALECT_SVG ? mxConstants.DIALECT_VML :
                    mxConstants.DIALECT_SVG, this.guideX.pointerEvents = !1, this.guideX.init(this.graph.getView().getOverlayPane())));
                m = m || d
            }, f = this.graph.getView().translate, g = this.graph.getView().scale, k = b.x, l = b.y, m = !1, n = null,
            p = null, q = !1, r = null, t = null, u = this.getGuideTolerance(), x = u, y = u, u = a.clone();
        u.x += b.x;
        u.y += b.y;
        var A = u.x, z = u.x + u.width, v = u.getCenterX(), B = u.y, C = u.y + u.height, F = u.getCenterY();
...
mxStencil.prototype.drawShape = function (a, b, c, d, e, f) {
    var g = mxUtils.getValue(b.style, mxConstants.STYLE_DIRECTION, null),
        g = this.computeAspect(b.style, c, d, e, f, g), k = Math.min(g.width, g.height),
        k = "inherit" == this.strokewidth ? Number(mxUtils.getNumber(b.style, mxConstants.STYLE_STROKEWIDTH, 1)) : Number(this.strokewidth) * k;
    a.setStrokeWidth(k);
    this.drawChildren(a, b, c, d, e, f, this.bgNode, g, !1);
    this.drawChildren(a, b, c, d, e, f, this.fgNode, g, !0)
};
mxStencil.prototype.drawChildren = function (a, b, c, d, e, f, g, k, l) {
    if (null != g && 0 < e && 0 < f) for (c = g.firstChild; null != c;) c.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, c, k, l), c = c.nextSibling
};
...
mxShape.prototype.configureCanvas = function (a, b, c, d, e) {
    ...
    null != this.fill && this.fill != mxConstants.NONE && this.gradient && this.gradient != mxConstants.NONE ? (b = this.getGradientBounds(a, b, c, d, e), a.setGradient(this.fill, this.gradient,
        b.x, b.y, b.width, b.height, this.gradientDirection)) : a.setFillColor(this.fill);
...
mxShape.prototype.addPoints = function (a, b, c, d, e) {
    ...
    for (a.moveTo(k.x, k.y); g < (e ? b.length : b.length - 1);) {
        ...
        if (!c || 0 == m && 0 == k) a.lineTo(l.x, l.y); else {
            ...
            for (k = b[mxUtils.mod(g + 1, b.length)]; g < b.length - 2 && 0 == Math.round(k.x - l.x) && 0 == Math.round(k.y - l.y);) k =
                b[mxUtils.mod(g + 2, b.length)], g++;
            m = k.x - l.x;
            k = k.y - l.y;
            n = Math.max(1, Math.sqrt(m * m + k * k));
            m = l.x + m * Math.min(d, n / 2) / n;
            k = l.y + k * Math.min(d, n / 2) / n;
...
mxArrowConnector.prototype.paintEdgeShape = function (a, b) {
    ...
    if (0 != u) {
        var x = t / u, y, A = x, z = r / u, v, B = z, u = f * z, C = -f * x, F = [];
        ...
        if (k && !g) this.paintMarker(a, b[0].x, b[0].y, x, z, n, d, f, m, !0); else {
            y = b[0].x + u / 2 + m * x;
            v = b[0].y + C / 2 + m * z;
            var D = b[0].x - u / 2 + m * x, I = b[0].y - C / 2 + m * z;
            g ? (a.moveTo(y, v), F.push(function () {
                a.lineTo(D, I)
            })) : (a.moveTo(D, I), a.lineTo(y, v))
        }
        for (var E = v = y = 0, u = 0; u < b.length - 2; u++) if (C = mxUtils.relativeCcw(b[u].x,
            ...
            var E = Math.max(tmp, Math.min(this.strokewidth / 200 + .04, .35)),
                E = 0 != C && p ? Math.max(.1, E) : Math.max(tmp, .06), G = b[u + 1].x + v * f / 2 / E,
                H = b[u + 1].y - y * f / 2 / E;
            v = b[u + 1].x - v * f / 2 / E;
            y = b[u + 1].y + y * f / 2 / E;
            0 != C && p ? -1 == C ? (C = v + B * f, E = y - A * f, a.lineTo(v + z * f, y - x * f), a.quadTo(G, H, C, E), function (b, c) {
                ...
                var d = G - z * f, e = H + x * f, g = G - B * f, k = H + A * f;
                F.push(function () {
                    a.quadTo(b, c, d, e)
                });
                F.push(function () {
        ...
        if (l && !g) this.paintMarker(a, q.x, q.y, -x, -z, c, e, f, m, !1); else {
            ...
            var J = q.x - m * A - u / 2, K = q.y - m * B - C / 2;
        ...
        2 < b.length && (a.setMiterLimit(4), k && !g && (a.begin(), this.paintMarker(a, b[0].x, b[0].y, t, r, n, d, f, m, !0), a.stroke(), a.end()), l && !g && (a.begin(), this.paintMarker(a, q.x, q.y, -x, -z, c, e, f, m, !0), a.stroke(), a.end()))
    }
};
...
mxText.prototype.paint = function (a, b) {
    ...
    if (b) null == this.node.firstChild || null != g && this.lastUnscaledWidth == g || a.invalidateCachedOffsetSize(this.node), a.updateText(d, e, f, c, this.align, this.valign, this.wrap, this.overflow, this.clipped, this.getTextRotation(), this.node); else {
        var k = mxUtils.isNode(this.value) ||
            this.dialect == mxConstants.DIALECT_STRICTHTML, l = k || a instanceof mxVmlCanvas2D ? "html" : "",
            m = this.value;
        k || "html" != l || (m = mxUtils.htmlEntities(m, !1));
        "html" != l || mxUtils.isNode(this.value) || (m = mxUtils.replaceTrailingNewlines(m, "<div><br></div>"));
        var m = !mxUtils.isNode(this.value) && this.replaceLinefeeds && "html" == l ? m.replace(/\n/g, "<br/>") : m,
            n = this.textDirection;
        n != mxConstants.TEXT_DIRECTION_AUTO || k || (n = this.getAutoDirection());
        n != mxConstants.TEXT_DIRECTION_LTR && n != mxConstants.TEXT_DIRECTION_RTL && (n = null);
...
mxStackLayout.prototype.execute = function (a) {
    if (null != a) {
        ...
        var e = e - (2 * this.spacing + 2 * this.border), f = this.x0 + this.border + this.marginLeft,
...
mxRadialTreeLayout.prototype.calcRowDims = function (a, b) {
    if (null != a && 0 != a.length) {
        ...
        this.row[b] = [];
        for (var c = !1, d = 0; d < a.length; d++) for (var e = null != a[d] ? a[d].child : null; null != e;) vertexBounds = this.getVertexBounds(e.cell), this.rowMinX[b] = Math.min(vertexBounds.x, this.rowMinX[b]), this.rowMaxX[b] = Math.max(vertexBounds.x + vertexBounds.width, this.rowMaxX[b]), this.rowMinCenX[b] = Math.min(vertexBounds.x +
    ...
    for (var c = !0, d = 0; c && 10 > d++;) for (var e = 1 == a % 2 && 1 == d % 2, c = !1, f = 0; f < b.ranks.length; f++) {
        ...
        for (var p = null, q = null, r, t, u = null, x = null, y, A = null, l = 0; l < g.length - 1; l++) {
            if (0 == l) {
                ...
                for (z =
                         0; z < n.length; z++) t[z] = n[z].getGeneralPurposeVariable(f - 1)
            ...
            for (var v = 0, B = 0, z = 0; z < r.length; z++) for (var C = 0; C < u.length; C++) r[z] > u[C] && v++, r[z] < u[C] && B++;
            for (z = 0; z < t.length; z++) for (C = 0; C < x.length; C++) t[z] > x[C] && v++, t[z] < x[C] && B++;
    ...
    if (101207 != a.temp[0]) {
        ...
        for (var e = 0, f = this.jettyPositions[a.ids[0]], g = a.isReversed ? a.target.cell : a.source.cell, k = this.layout.graph, l = this.orientation == mxConstants.DIRECTION_EAST || this.orientation == mxConstants.DIRECTION_SOUTH, m = 0; m < a.edges.length; m++) {
            ...
            for (; a.maxRank != a.minRank && t != x; t += u) {
                var y = a.x[t] + b, A = (this.rankTopY[p] + this.rankBottomY[p + 1]) / 2,
                    z = (this.rankTopY[p - 1] + this.rankBottomY[p]) / 2;
                if (r) var v = A, A = z, z = v;
...
mxGraphModel.prototype.parentForCellChanged = function (a, b, c) {
    ...
    this.contains(d) || null == b ? null == b && this.cellRemoved(a) : this.cellAdded(a);
    return d
};
    ...
    try {
        ...
        var y = mxUtils.bind(this, function () {
            ...
            if (c || b) a.style.pageBreakAfter =
                "always";
            g && (mxClient.IS_IE || 11 <= document.documentMode || mxClient.IS_EDGE) ? (k.writeln(a.outerHTML), a.parentNode.removeChild(a)) : (a.parentNode.removeChild(a), k.body.appendChild(a));
            (c || b) && this.addPageBreak(k)
        }), z = this.getCoverPages(this.pageFormat.width, this.pageFormat.height);
        if (null != z) for (var v = 0; v < z.length; v++) A(z[v], !0);
        for (var B = this.getAppendices(this.pageFormat.width, this.pageFormat.height), v = 0; v < x; v++) {
            ...
            for (a = 0; a < u; a++) {
                ...
                var F = a * r / this.scale - this.x0 / this.scale + (m.x - q.x * n) / n, D = v * u + a + 1,
                    I = new mxRectangle(F, C, r, t),
                    f = this.renderPage(this.pageFormat.width, this.pageFormat.height, 0, 0, mxUtils.bind(this, function (a) {
                        this.addGraphFragment(-F, -C, this.scale, D, a, I);
                        this.printBackgroundImage && this.insertBackgroundImage(a, -F, -C)
                    }), D);
                f.setAttribute("id", "mxPage-" + D);
                A(f, null != B || v < x - 1 || a < u - 1)
            }
        }
        if (null != B) for (v = 0; v < B.length; v++) A(B[v], v < B.length - 1);
...
mxPrintPreview.prototype.addGraphFragment = function (a, b, c, d, e, f) {
    ...
    g.translate = new mxPoint(a,
        b);
    var t = this.graph.cellRenderer.redraw, u = g.states;
    a = g.scale;
    if (this.clipping) {
...
mxCellEditor.prototype.resize = function () {
    ...
    if (null == a) this.stopEditing(!0); else if (null != this.textarea) {
        ...
        if (this.autoSize && "fill" != a.style[mxConstants.STYLE_OVERFLOW]) {
            ...
            8 == document.documentMode && (this.textarea.style.zoom = "1", this.textarea.style.height =
                "auto");
...
mxCellEditor.prototype.startEditing = function (a, b) {
    ...
    if (null != c) {
        ...
        var d = mxUtils.getValue(c.style, mxConstants.STYLE_FONTSIZE, mxConstants.DEFAULT_FONTSIZE),
            ...
            f = mxUtils.getValue(c.style, mxConstants.STYLE_FONTCOLOR, "black"), g = mxUtils.getValue(c.style,
...
mxCellEditor.prototype.stopEditing = function (a) {
    if (null != this.editingCell) {
        ...
        null != a && this.textarea.innerHTML != b && (this.prepareTextarea(), b = this.getCurrentValue(a), null != b && this.applyValue(a, b));
...
mxCellRenderer.prototype.redrawLabel = function (a, b) {
    ...
    if (null != a.text) {
        ...
        var e = this.getLabelBounds(a), f = d.isWrapping(a.cell), d = d.isLabelClipped(a.cell), g =
                a.view.graph.isHtmlLabel(a.cell) || null != c && mxUtils.isNode(c) ? mxConstants.DIALECT_STRICTHTML : a.view.graph.dialect,
...
mxCellRenderer.prototype.rotateLabelBounds = function (a, b) {
    ...
    0 != e && null != a && a.view.graph.model.isVertex(a.cell) && (c = a.getCenterX(), d = a.getCenterY(), b.x != c || b.y != d) && (e *= Math.PI / 180, pt = mxUtils.getRotatedPoint(new mxPoint(b.x, b.y), Math.cos(e), Math.sin(e), new mxPoint(c, d)), b.x = pt.x, b.y =
        pt.y)
};
...
mxCellRenderer.prototype.redrawShape = function (a, b, c) {
    ...
    null == a.shape && null != a.view.graph.container && a.cell != a.view.currentRoot && (d.isVertex(a.cell) || d.isEdge(a.cell)) ? (a.shape = this.createShape(a), null != a.shape && (a.shape.antiAlias = this.antiAlias, this.createIndicatorShape(a), this.initializeShape(a), this.createCellOverlays(a),
        this.installListeners(a), a.view.graph.selectionCellsHandler.updateHandler(a))) : null == a.shape || mxUtils.equalEntries(a.shape.style, a.style) || (a.shape.resetStyles(), this.configureShape(a), a.view.graph.selectionCellsHandler.updateHandler(a), b = !0);
    null != a.shape && (this.createControl(a), b || null == a.shape.bounds || a.shape.scale != a.view.scale || null == a.absolutePoints && !a.shape.bounds.equals(a) || null != a.absolutePoints && !mxUtils.equalPoints(a.shape.points, a.absolutePoints)) && (null != a.absolutePoints ? (a.shape.points =
        a.absolutePoints.slice(), a.shape.bounds = null) : (a.shape.points = null, a.shape.bounds = new mxRectangle(a.x, a.y, a.width, a.height)), a.shape.scale = a.view.scale, null == c || c ? a.shape.redraw() : a.shape.updateBoundingBox(), e = !0);
    return e
};
...
var mxEdgeStyle = {
    ...
    ElbowConnector: function (a, b, c, d, e) {
        ...
        if (null != b && null != c) if (null != f) var l = Math.min(b.x, c.x),
            ...
            n = Math.max(b.y + b.height, c.y + c.height), f = a.view.transformControlPoint(a,
                f), g = f.y < k || f.y > n,
    ...
    SegmentConnector: function (a, b, c, d, e) {
        ...
        var g = a.absolutePoints, k = Math.max(1, a.view.scale), l = 0 < e.length ? e[0] : null, m = !0, n = null,
            p = g[0];
        ...
        if (null != d && 0 < d.length) {
            ...
            t = g[q];
            null != t && null != d[d.length - 1] && (Math.abs(d[d.length - 1].x - t.x) < k && (d[d.length - 1].x = t.x), Math.abs(d[d.length - 1].y - t.y) < k && (d[d.length - 1].y = t.y));
            var n = d[0], u = b, x = g[0], y = !1, A = !1, y = n;
            null != x && (x.x = Math.round(x.x), x.y = Math.round(x.y), u = null);
            for (r = 0; 2 > r; r++) {
                var z = null != x && x.x == y.x, v = null != x && x.y == y.y,
                    B = null != u && y.y >= u.y && y.y <= u.y +
                        u.height, u = null != u && y.x >= u.x && y.x <= u.x + u.width, y = v || null == x && B,
                    A = z || null == x && u;
                if (0 != r || !(y && A || z && v)) {
                    if (null != x && !v && !z && (B || u)) {
                        m = B ? !1 : !0;
    ...
    getJettySize: function (a, b, c, d, e) {
        ...
        "auto" == b && (mxUtils.getValue(a.style, e ? mxConstants.STYLE_STARTARROW : mxConstants.STYLE_ENDARROW, mxConstants.NONE) != mxConstants.NONE ? (a = mxUtils.getNumber(a.style, e ? mxConstants.STYLE_STARTSIZE : mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE), b = Math.max(2, Math.ceil((a + mxEdgeStyle.orthBuffer) /
            mxEdgeStyle.orthBuffer)) * mxEdgeStyle.orthBuffer) : b = 2 * mxEdgeStyle.orthBuffer);
        return b
    },
    OrthConnector: function (a, b, c, d, e) {
        var f = a.view.graph, g = null == b ? !1 : f.getModel().isEdge(b.cell),
            k = null == c ? !1 : f.getModel().isEdge(c.cell), f = a.absolutePoints, l = f[0], m = f[f.length - 1],
            n = null != b ? b.x : l.x, p = null != b ? b.y : l.y, q = null != b ? b.width : 0,
            r = null != b ? b.height : 0, t = null != c ? c.x : m.x, u = null != c ? c.y : m.y,
            x = null != c ? c.width : 0, y = null != c ? c.height : 0,
            f = a.view.scale * mxEdgeStyle.getJettySize(a, b, c, d, !0), A = a.view.scale * mxEdgeStyle.getJettySize(a,
            b, c, d, !1);
        null != b && c == b && (f = A = Math.max(f, A));
        var z = A + f, v = !1;
        if (null != l && null != m) var v = m.x - l.x, B = m.y - l.y, v = v * v + B * B < z * z;
        if (v || mxEdgeStyle.orthPointsFallback && null != d && 0 < d.length || g || k) mxEdgeStyle.SegmentConnector(a, b, c, d, e); else {
            ...
            null != b && (d[0] = mxUtils.getPortConstraints(b, a, !0, mxConstants.DIRECTION_MASK_ALL), v = mxUtils.getValue(b.style, mxConstants.STYLE_ROTATION, 0), 0 != v && (v = mxUtils.getBoundingBox(new mxRectangle(n, p, q, r), v), n = v.x, p = v.y,
                q = v.width, r = v.height));
            null != c && (d[1] = mxUtils.getPortConstraints(c, a, !1, mxConstants.DIRECTION_MASK_ALL), v = mxUtils.getValue(c.style, mxConstants.STYLE_ROTATION, 0), 0 != v && (v = mxUtils.getBoundingBox(new mxRectangle(t, u, x, y), v), t = v.x, u = v.y, x = v.width, y = v.height));
            ...
            n = [[n, p, q, r], [t, u, x, y]];
            A = [f, A];
            for (v = 0; 2 > v; v++) mxEdgeStyle.limits[v][1] =
                n[v][0] - A[v], mxEdgeStyle.limits[v][2] = n[v][1] - A[v], mxEdgeStyle.limits[v][4] = n[v][0] + n[v][2] + A[v], mxEdgeStyle.limits[v][8] = n[v][1] + n[v][3] + A[v];
            A = n[0][1] + n[0][3] / 2;
            p = n[1][1] + n[1][3] / 2;
    ...
    getRoutePattern: function (a, b, c, d) {
        ...
        0 != c && 0 != d || null == inlineRoutePatterns[e - 1][a -
...
mxGraph.prototype.fit = function (a, b, c, d, e, f) {
    if (null != this.container) {
        ...
        e = null != e ? e : !1;
        f = null != f ? f : !1;
        var g = this.getBorderSizes(), k = this.container.offsetWidth - g.x - g.width - 1,
            l = this.container.offsetHeight - g.y - g.height - 1, g = this.view.getGraphBounds();
        if (0 < g.width && 0 < g.height) {
            b && null != g.x && null != g.y && (g = g.clone(), g.width += g.x, g.height += g.y, g.x = 0, g.y = 0);
            var m = this.view.scale, n = g.width / m, p = g.height / m;
            null != this.backgroundImage && (n = Math.max(n,
                this.backgroundImage.width - g.x / m), p = Math.max(p, this.backgroundImage.height - g.y / m));
            var q = (b ? a : 2 * a) + c, k = k - q, l = l - q;
            e = e ? l / p : f ? k / n : Math.min(k / n, l / p);
...
mxGraph.prototype.sizeDidChange = function () {
    ...
    if (null != this.container) {
        var b = this.getBorder(), c = Math.max(0, a.x + a.width + b), b = Math.max(0, a.y + a.height + b);
...
mxGraph.prototype.getCellStyle = function (a) {
    ...
    null == a && (a = mxGraph.prototype.EMPTY_ARRAY);
    return a
};
...
mxGraph.prototype.cloneCells = function (a, b, c) {
    ...
    if (null != a) {
        ...
        if (0 < d.length) for (var g = this.view.scale, k = this.view.translate, d = this.model.cloneCells(a, !0, c), f = 0; f < a.length; f++) if (!b && this.model.isEdge(d[f]) && null != this.getEdgeValidationError(d[f], this.model.getTerminal(d[f], !0), this.model.getTerminal(d[f], !1))) d[f] = null; else {
            var l = this.model.getGeometry(d[f]);
            if (null != l) {
                var m = this.view.getState(a[f]),
                    n = this.view.getState(this.model.getParent(a[f]));
                if (null != m && null != n) if (c = n.origin.x, n = n.origin.y, this.model.isEdge(d[f])) {
                    ...
                    if (null != l) {
                        ...
                        if (null != m) {
                            ...
                            if (r) {
                                ...
                                m = m.absolutePoints;
                                t = g ? 0 : m.length - 1;
                                l.setTerminalPoint(new mxPoint(m[t].x / b - q, m[t].y / b - r), g);
                                this.model.setTerminal(f[k], null, g);
                                this.model.setGeometry(f[k], l)
                            }
                        }
                    }
...
mxGraph.prototype.getPreferredSizeForCell = function (a) {
    ...
    if (null != a) {
        ...
        if (!this.model.isEdge(a)) {
            ...
            a = b = 0;
            null == this.getImage(c) && null == d[mxConstants.STYLE_IMAGE] || d[mxConstants.STYLE_SHAPE] != mxConstants.SHAPE_LABEL || (d[mxConstants.STYLE_VERTICAL_ALIGN] == mxConstants.ALIGN_MIDDLE && (b += parseFloat(d[mxConstants.STYLE_IMAGE_WIDTH]) || mxLabel.prototype.imageSize), d[mxConstants.STYLE_ALIGN] !=
...
mxGraph.prototype.scaleCell = function (a, b, c, d) {
    var e = this.model.getGeometry(a);
    if (null != e) {
        var f = this.view.getState(a), f = null != f ? f.style : this.getCellStyle(a), e = e.clone(), g = e.x, k = e.y,
            l = e.width, m = e.height;
        ...
        if (null != b && b != this.getDefaultParent()) {
            ...
            if (null != c) {
                ...
                if (this.isSwimlane(b)) {
                    var f = this.getStartSize(b), g = this.view.getState(b),
...
mxGraph.prototype.getOutlineConstraint = function (a, b, c) {
    if (null != b.shape) {
        ...
        return new mxConnectionConstraint(new mxPoint(Math.round(1E3 * (a.x - c.x) / c.width) /
...
mxGraph.prototype.getConnectionPoint = function (a, b) {
    ...
    if (null != a && null != b.point) {
        var d = this.view.getPerimeterBounds(a), e = new mxPoint(d.getCenterX(), d.getCenterY()),
            c = a.style[mxConstants.STYLE_DIRECTION], f = 0;
        ...
        this.getModel().isVertex(a.cell) && (f = 1 == a.style[mxConstants.STYLE_FLIPH], k = 1 == a.style[mxConstants.STYLE_FLIPV], null != a.shape && null != a.shape.stencil && (f = 1 == mxUtils.getValue(a.style, "stencilFlipH", 0) || f, k = 1 == mxUtils.getValue(a.style, "stencilFlipV", 0) || k), f && (c.x = 2 * d.getCenterX() - c.x), k && (c.y = 2 * d.getCenterY() - c.y));
        0 != g && null != c && (d = mxUtils.toRadians(g),
...
mxGraph.prototype.center = function (a, b, c, d) {
    ...
    c = null != c ? c : .5;
    d = null != d ? d : .5;
    var e = mxUtils.hasScrollbars(this.container), f = this.container.clientWidth, g = this.container.clientHeight,
        k = this.getGraphBounds(), l = this.view.translate, m = this.view.scale, n = a ? f - k.width : 0,
        p = b ? g - k.height : 0;
        ...
        if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && mxEvent.isTouchEvent(b.getEvent())) {
            ...
            if (!mxClient.IS_QUIRKS && a == mxEvent.MOUSE_DOWN || mxClient.IS_QUIRKS && a == mxEvent.MOUSE_UP && !this.fireDoubleClick) if (null != this.lastTouchEvent &&
                ...
                if (this.doubleClickCounter++, d = !1, a == mxEvent.MOUSE_UP ? b.getCell() == this.lastTouchCell && null != this.lastTouchCell && (this.lastTouchTime = 0, d = this.lastTouchCell, this.lastTouchCell = null, mxClient.IS_QUIRKS && b.getSource().fireEvent("ondblclick"), this.dblClick(b.getEvent(), d), d = !0) : (this.fireDoubleClick =
                    !0, this.lastTouchTime = 0), !mxClient.IS_QUIRKS || d) {
    ...
    if (!b.isConsumed() && c.isMouseDown && null != this.cell && null != this.first && null != this.bounds) if (mxEvent.isMultiTouchEvent(b.getEvent())) this.reset(); else {
        ...
        if (null != this.shape || Math.abs(e) > f || Math.abs(d) > f) {
            ...
            var g = c.isGridEnabledEvent(b.getEvent()),
                f = !0;
            if (null != this.guide && this.useGuidesForEvent(b)) d = this.guide.move(this.bounds, new mxPoint(e, d), g), f = !1, e = d.x, d = d.y; else if (g) var k = c.getView().translate,
                l = c.getView().scale, g = this.bounds.x - (c.snap(this.bounds.x / l - k.x) + k.x) * l,
                k = this.bounds.y - (c.snap(this.bounds.y / l - k.y) + k.y) * l, d = this.snap(new mxPoint(e, d)),
                e = d.x - g, d = d.y - k;
        ...
        if (null != this.cell && null != this.first && null != this.shape && null != this.currentDx && null != this.currentDy) {
            ...
            if (this.connectOnDrop && null == this.target && null != d && c.getModel().isVertex(d) && c.isCellConnectable(d) && c.isEdgeValid(null, this.cell, d)) c.connectionHandler.connect(this.cell, d, b.getEvent()); else {
                var d = c.isCloneEvent(b.getEvent()) && c.isCellsCloneable() && this.isCloneEnabled(),
                    e = c.getView().scale, f = this.roundLength(this.currentDx /
...
mxConnectionHandler.prototype.updateCurrentState = function (a, b) {
    ...
    if (null != this.constraintHandler.currentFocus && null != this.constraintHandler.currentConstraint) null != this.marker.highlight && null != this.marker.highlight.state && this.marker.highlight.state.cell == this.constraintHandler.currentFocus.cell ? "transparent" != this.marker.highlight.shape.stroke && (this.marker.highlight.shape.stroke = "transparent",
        ...
        this.outlineConnect && null != this.marker.highlight && null != this.marker.highlight.shape && (c = this.graph.view.scale, null != this.constraintHandler.currentConstraint && null !=
    ...
    if (b.isConsumed() || !this.ignoreMouseDown && null == this.first && this.graph.isMouseDown) this.constraintHandler.reset(); else {
        ...
        if (null != this.first) {
            ...
            if (null != this.selectedIcon) {
                ...
                null != this.currentState && this.targetConnectImage ? (g = this.getIconPosition(this.selectedIcon, this.currentState), this.selectedIcon.bounds.x = g.x, this.selectedIcon.bounds.y = g.y) : (g = new mxRectangle(b.getGraphX() + this.connectIconOffset.x, b.getGraphY() + this.connectIconOffset.y, g, k), this.selectedIcon.bounds =
                    g);
        ...
        if (!this.graph.isMouseDown && null != this.currentState && null != this.icons) {
            ...
            d = b.getSource();
            for (e =
                     0; e < this.icons.length && !c; e++) c = d == this.icons[e].node || d.parentNode == this.icons[e].node;
...
mxConnectionHandler.prototype.mouseUp = function (a, b) {
    if (!b.isConsumed() && this.isConnecting()) {
        ...
        if (null == this.error) {
            this.edgeState = this.changeEdgeStyle(b);
    ...
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        ...
        if (null != this.focusIcons && null != this.constraints && (null == k || this.currentFocus == k)) for (var g = e.getCenterX(), l = e.getCenterY(), m = 0; m < this.focusIcons.length; m++) {
            ...
            if ((this.intersects(this.focusIcons[m], e, b, c) || null != d && this.intersects(this.focusIcons[m], f, b, c)) && (null == a || n < a)) {
                ...
                mxClient.IS_IE && (n.grow(1), --n.width, --n.height);
...
mxVertexHandler.prototype.start = function (a, b, c) {
    ...
    if (this.livePreview) for (this.hideSizers(), c == mxEvent.ROTATION_HANDLE ? this.rotationShape.node.style.display =
...
mxVertexHandler.prototype.rotateVertex = function (a) {
    ...
    this.rotationRaster && this.graph.isGridEnabledEvent(a.getEvent()) ? (c = b.x - this.state.getCenterX(), d = b.y - this.state.getCenterY(), a = Math.max(1, 5 * Math.min(3, Math.max(0, Math.round(80 / Math.abs(3 * Math.abs(Math.sqrt(c * c + d * d) - 20)))))), this.currentAlpha =
...
mxVertexHandler.prototype.resizeVertex = function (a) {
    var b = new mxPoint(this.state.getCenterX(), this.state.getCenterY()),
        ...
        g = Math.cos(-c), k = Math.sin(-c), l = d.x - this.startX, d = d.y - this.startY, m = k * l + g * d,
        l = g * l - k * d, d = m, g = this.graph.getCellGeometry(this.state.cell);
    ...
    0 == b && 0 == c ? this.childOffsetY = this.childOffsetX = 0 : (this.childOffsetX = this.state.x - this.bounds.x + e, this.childOffsetY = this.state.y - this.bounds.y + g);
...
mxVertexHandler.prototype.mouseUp = function (a, b) {
    if (null != this.index && null != this.state) {
        ...
        try {
            if (this.index <= mxEvent.CUSTOM_HANDLE) null != this.customHandles && (this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].active = !1, this.customHandles[mxEvent.CUSTOM_HANDLE - this.index].execute()); else if (this.index == mxEvent.ROTATION_HANDLE) if (null != this.currentAlpha) {
                ...
                var e = this.graph.isGridEnabledEvent(b.getEvent()),
                    f = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"), g = Math.cos(-f),
                    k = Math.sin(-f), l = c.x - this.startX, m = c.y - this.startY, c = k * l + g * m,
                    l = g * l - k * m, m = c, n = this.graph.view.scale, p = this.isRecursiveResize(this.state, b);
...
mxVertexHandler.prototype.reset = function () {
    ...
    if (null != this.customHandles) for (a = 0; a < this.customHandles.length; a++) this.customHandles[a].active ?
...
mxVertexHandler.prototype.union = function (a, b, c, d, e, f, g, k, l) {
    ...
    if (0 == d || 3 == d || 5 == d) p += b, e && (p = this.graph.snap(p / f) * f); else if (2 == d || 4 == d || 7 == d) q += b, e && (q = this.graph.snap(q /
        f) * f);
    e = q - p;
    c = r - a;
...
mxVertexHandler.prototype.redrawHandles = function () {
        ...
        if (this.singleSizer) this.moveSizerTo(this.sizers[0], a, c); else {
            ...
            if (8 <= this.sizers.length) {
                var f = "nw-resize n-resize ne-resize e-resize se-resize s-resize sw-resize w-resize".split(" "),
                    ...
                    l = Math.sin(g), g = Math.round(4 * g / Math.PI), m = new mxPoint(b.getCenterX(), b.getCenterY()),
    ...
    if (null != this.customHandles) for (b = 0; b < this.customHandles.length; b++) a = this.customHandles[b].shape.node.style.display, this.customHandles[b].redraw(), this.customHandles[b].shape.node.style.display =
        a;
...
mxEdgeHandler.prototype.updatePreviewState = function (a, b, c, d, e) {
    ...
    (this.isSource || this.isTarget) && null == c && (a.setAbsoluteTerminalPoint(b, this.isSource), null == this.marker.getMarkedState() && (this.error =
    ...
    if (null != this.index && null != this.marker) {
        ...
        if (b.getX() != this.startX || b.getY() != this.startY) {
            ...
            if (null != this.error) 0 < this.error.length && this.graph.validationAlert(this.error); else if (this.index <= mxEvent.CUSTOM_HANDLE && this.index > mxEvent.VIRTUAL_HANDLE) {
                ...
                null == e && this.marker.hasValidState() && null != this.marker.highlight && null != this.marker.highlight.shape && "transparent" != this.marker.highlight.shape.stroke &&
...
mxCodec.prototype.getElementById = function (a) {
    if (null == this.elements) {
        if (null == this.document.documentElement) throw Error("mxCodec constructor needs document parameter");
        this.elements = {};
...
var mxStylesheetCodec = mxCodecRegistry.register(function () {
    ...
    a.getStringValue =
        function (a, c) {
            var b = typeof c;
            "function" == b ? c = mxStyleRegistry.getName(style[j]) : "object" == b && (c = null);
            return c
        };
            ...
            for (c = c.firstChild; null != c;) {
                if (c.nodeType == mxConstants.NODETYPE_ELEMENT && !this.processInclude(a, c, d)) if ("separator" == c.nodeName) d.addSeparator(); else if ("br" == c.nodeName) d.toolbar.addBreak(); else if ("hr" == c.nodeName) d.toolbar.addLine(); else if ("add" == c.nodeName) {
                    ...
                    if (null != l) r = d.addItem(f, g, l, k); else if (null != m) var t = mxDefaultToolbarCodec.allowEval ? mxUtils.eval(q) : null,
                        r = d.addMode(f, g, m, k, t); else if (null != n || null != q && 0 < q.length) r = b.templates[n], n = c.getAttribute("style"), null != r && null != n && (r = b.graph.cloneCells([r])[0], r.setStyle(n)), n = null, null != q && 0 < q.length &&
        ...
        for (a = c.firstChild; null != a;) {
            if ("add" == a.nodeName) {
                ...
                if (null != b) b = document.getElementById(b), null != b && null != f && (b.style.cssText += ";" + f); else {
                    var g = parseInt(a.getAttribute("x")), k = parseInt(a.getAttribute("y")),
                        l = a.getAttribute("width"), m = a.getAttribute("height"), b = document.createElement("div");
                    b.style.cssText = f;
